...
class DataItemCrism extends React.Component {
  ...
  render() {
    ...
    const link_tool = this.props.data.external_link;
    return (
      <div className="list-group-item list-group-item-action">
        <div className="media">
          <div className="media-left media-middle">
            <a href={this.props.data.thumbnail_url} target="_blank">
              {/*<img src={image_icon} style={{height:'60px'}}/>*/}
              <img className="media-object" style={{height:'60px'}}
                  src={this.props.data.thumbnail_url} alt="" />
            </a>
          </div>
          <div className="media-body">
            <div className="well well-sm" style={{float:'right'}}>
              ...
              {/*<hr style={{height:'5px', border:0, display:'block', padding:0, borderTop:'1px solid #ccc', marginTop:2, marginBottom:0}}/>*/}
            ...
            <h4 className="media-heading" style={{wordWrap:'break-word', wordBreak:'break-all', whiteSpace:'normal !important'}}>{this.props.data.granule_uid}</h4>
          </div>
        </div>
      </div>
    );
